...
from pipelines.ingestion.ops.copy_and_insert_to_production import copy_and_insert_to_production
from pipelines.ingestion.ops.post_ingest_maintenance import post_ingest_maintenance
from pipelines.ingestion.ops.unzip_and_discover import unzip_and_discover
    ...
    if skip_if_logged:
        try:
            ...
            try:
                ...
                logger.debug("Quiet close failed: %s", e)
