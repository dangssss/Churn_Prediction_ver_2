...
from features.engineering.feature_gen.db_utils import execute_sql, build_bccp_src
...
def _render_window_sqls(engine, table_name: str, start_date: str, end_date: str, start_ym: str, end_ym: str, window_size: int):
    ...
    create_sql = render_template('sliding_table', 
                                TABLE_NAME=table_name, 
                                TABLE_SAFE=table_safe, 
                                MONTHLY_COLUMNS=monthly_cols_str)
    
    insert_sql = render_template('sliding_aggregate',
                         TABLE_NAME=table_name,
                         START_DATE=start_date,
                         END_DATE=end_date,
                         WINDOW_SIZE=window_size,
